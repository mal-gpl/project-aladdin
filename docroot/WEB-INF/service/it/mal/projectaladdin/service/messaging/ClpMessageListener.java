...
package it.mal.projectaladdin.service.messaging;
...
import it.mal.projectaladdin.service.ClpSerializer;
...
public class ClpMessageListener extends BaseMessageListener {
	...
	protected void doReceive(Message message) throws Exception {
		...
		if (command.equals("undeploy") &&
			...
			CategoryWishlistLocalServiceUtil.clearService();

			WishLocalServiceUtil.clearService();

			WishlistLocalServiceUtil.clearService();
		}
	}
}