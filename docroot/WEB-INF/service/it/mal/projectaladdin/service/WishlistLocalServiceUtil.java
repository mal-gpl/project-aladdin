...
/**
 * The utility for the wishlist local service. This utility wraps {@link it.mal.projectaladdin.service.impl.WishlistLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see it.mal.projectaladdin.service.base.WishlistLocalServiceBaseImpl
...
public class WishlistLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link it.mal.projectaladdin.service.impl.WishlistLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static it.mal.projectaladdin.model.Wishlist addWishlist(
	...
	*/
	public static it.mal.projectaladdin.model.Wishlist createWishlist(
		long wishlistId) {
		return getService().createWishlist(wishlistId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteWishlist(long wishlistId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteWishlist(wishlistId);
	}
	...
	*/
	public static void deleteWishlist(
		it.mal.projectaladdin.model.Wishlist wishlist)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteWishlist(wishlist);
	}
	...
	*/
	...
	public static it.mal.projectaladdin.model.Wishlist fetchWishlist(
		long wishlistId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchWishlist(wishlistId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.mal.projectaladdin.model.Wishlist getWishlist(
		long wishlistId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getWishlist(wishlistId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<it.mal.projectaladdin.model.Wishlist> getWishlists(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static it.mal.projectaladdin.model.Wishlist updateWishlist(
		it.mal.projectaladdin.model.Wishlist wishlist)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static it.mal.projectaladdin.model.Wishlist updateWishlist(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateWishlist(wishlist, merge);
	}
	...
	*/
	...
	public static WishlistLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					WishlistLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					WishlistLocalService.class.getName(), portletClassLoader);

			_service = new WishlistLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(WishlistLocalServiceUtil.class,
				"_service");
			MethodCache.remove(WishlistLocalService.class);
		}

		return _service;
	}

	public void setService(WishlistLocalService service) {
		MethodCache.remove(WishlistLocalService.class);
	...
	private static WishlistLocalService _service;
}